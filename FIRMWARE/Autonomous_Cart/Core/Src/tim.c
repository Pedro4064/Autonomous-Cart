...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM16_MspDeInit 0 */
    ...
    PB4     ------> TIM16_CH1
    */
    HAL_GPIO_DeInit(LEFT_ENCODER_GPIO_Port, LEFT_ENCODER_Pin);
  ...
  /* USER CODE END TIM17_MspDeInit 0 */
    ...
    PB5     ------> TIM17_CH1
    */
    HAL_GPIO_DeInit(RIGHT_ENCODER_GPIO_Port, RIGHT_ENCODER_Pin);
...
void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef* tim_icHandle)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PC6     ------> TIM3_CH1
    */
    HAL_GPIO_DeInit(ULTRASSONIC_ECO_GPIO_Port, ULTRASSONIC_ECO_Pin);
