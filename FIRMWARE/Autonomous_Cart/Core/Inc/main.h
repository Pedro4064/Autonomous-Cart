...
#define DISTANCE_IR_FRONTAL_Pin GPIO_PIN_1
#define DISTANCE_IR_FRONTAL_GPIO_Port GPIOA
...
#define RIGHT_MOTOR_DIR_IN1_Pin GPIO_PIN_12
#define RIGHT_MOTOR_DIR_IN1_GPIO_Port GPIOB
