/* Include files */
#include "rtwtypes.h"
#include "slcc_interface_nS1ddewZyIbRIrbNe8pdHB.h"
...
const char_T *get_dll_checksum_nS1ddewZyIbRIrbNe8pdHB(void)
{
    return "RuI9lsZyj4VlPjolGah0QF";
}

int32_T pqp_nS1ddewZyIbRIrbNe8pdHB(int32_T b)
{
    return pqp(b);
}
